...
updated: 2026-02-18
---
<Paper title="CTLA-4 expressed by Treg cells contributes to their function in vivo" authors="Kajsa Wing et al." journal="Science" year={2008} takeaway="Treg에서 발현되는 CTLA-4가 생체 내 억제 기능에 필수적임을 유전자 특이적 결손 모델로 직접 증명한 연구." />
<Paper title="Conditional deletion of CTLA-4 in adult Treg cells reveals the developmental timing of CTLA-4 function" authors="Kajsa Wing et al." journal="Immunity" year={2016} takeaway="성체에서 유도적으로 CTLA-4를 제거해, Treg 억제 기능의 시기 의존성과 보상 기전을 규명한 연구." />
