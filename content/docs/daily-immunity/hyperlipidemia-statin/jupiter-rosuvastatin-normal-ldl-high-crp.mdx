...
연구는 원래 더 오래 진행될 예정이었지만, 중앙 추적기간 1.9년에 중간 분석에서 차이가 뚜렷해 조기 종료되었습니다. Rosuvastatin군에서는 LDL 콜레스테롤이 50%, hs-CRP가 37% 낮아졌습니다.

1차 복합 평가변수의 발생률은 rosuvastatin군에서 100인년당 0.77건, 위약군에서 1.36건이었습니다. 위험비는 0.56(95% CI 0.46–0.69)으로, 상대위험은 44% 낮았습니다. 절대 발생률 차이는 100인년당 0.59건이었습니다. 전체 사망률도 rosuvastatin군 1.00건, 위약군 1.25건으로 낮았습니다(HR 0.80; 95% CI 0.67–0.97).

<Figure
  src="/images/diagram/jupiter1.svg"
  alt="JUPITER 임상에서 rosuvastatin군과 위약군의 심혈관 사건 누적 발생률 비교"
  number={1}
  maxWidth={760}
  caption="Rosuvastatin군과 위약군의 누적 사건 발생률. A는 1차 복합 평가변수, B는 심근경색·뇌졸중·심혈관 사망, C는 재개통술 또는 불안정 협심증 입원, D는 전체 사망을 보여줍니다. 출처: Ridker et al., NEJM, 2008."
/>
