...
| 항목 | 내용 |
|---|---|
| 연구명 | A TO Z Weight Loss Study |
| 연구 유형 | 무작위 임상시험 |
| 대상자 | 과체중·비만 폐경 전 여성 311명 |
| 기간 | 12개월 |
| 비교군 | Atkins, Zone, LEARN, Ornish |
| 핵심 개입 | 탄수화물 섭취량이 서로 다른 네 식단을 교육하고 추적 |
| 주요 평가 지표 | 12개월 체중 변화와 대사 위험 지표 |
| 주요 결과 | Atkins군의 평균 체중감량이 가장 컸고 일부 대사 지표도 유리했습니다. |
| 해석 포인트 | 저탄수화물 식단의 가능성을 보여주었지만, 실제 섭취와 순응도 변화까지 함께 해석해야 합니다. |
