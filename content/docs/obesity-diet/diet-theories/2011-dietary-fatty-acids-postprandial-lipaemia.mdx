...
<Figure
  src="/images/diagram/2011-fielding-plasma-nefa-glucose-fructose.svg"
  alt="포도당과 과당 섭취 후 혈중 유리지방산 농도와 지방조직 분해 기여의 시간 변화"
  number={1}
  maxWidth={900}
  caption="혈중 유리지방산은 단순한 지방분해 지표가 아닙니다. 포도당이나 과당 섭취 뒤 초기에는 인슐린 효과로 지방조직의 세포내 지방분해가 억제되어 NEFA가 내려가지만, 시간이 지나면 다시 올라옵니다. Fielding은 이 늦은 식후 NEFA 풀에 식이지방에서 유래한 spillover 지방산이 크게 섞일 수 있다고 설명합니다."
/>
...
<Figure
  src="/images/diagram/2018-piche-chylomicron-spillover-bmi.svg"
  alt="낮은 BMI와 높은 BMI 참가자에서 식후 킬로미크론 유래 지방산 spillover 비교"
  number={2}
  maxWidth={900}
  caption="BMI에 따른 킬로미크론 유래 지방산 spillover. Piche 등은 식사 지방에 표지한 palmitate가 혈장 중성지방, 킬로미크론 중성지방, NEFA, VLDL 중성지방에 어떻게 나타나는지 추적했습니다. 핵심은 낮은 BMI 집단에서 킬로미크론 유래 지방산이 혈장 NEFA 풀로 들어가는 비율이 더 높았다는 점입니다."
/>

<Figure
  src="/images/diagram/2018-piche-chylomicron-spillover-sex.svg"
  alt="BMI를 맞춘 여성과 남성에서 식후 킬로미크론 유래 지방산 spillover 비교"
  number={3}
  maxWidth={900}
  caption="성별에 따른 킬로미크론 유래 지방산 spillover. 나이와 BMI를 맞춘 비교에서 여성은 남성보다 킬로미크론 유래 지방산이 혈장 NEFA 풀로 spillover되는 비율이 더 높았습니다. 저자들은 이것을 비만의 병적 누출이라기보다, 식후 중성지방 처리와 지방산 흐름이 더 역동적인 상태의 한 신호로 해석합니다."
/>
...
<Figure
  src="/images/diagram/2018-piche-chylomicron-spillover-correlations.svg"
  alt="킬로미크론 유래 지방산 spillover와 BMI, 허리둘레, HOMA-IR, 공복 중성지방의 상관관계"
  number={4}
  maxWidth={820}
  caption="대사 지표와 spillover의 상관관계. 킬로미크론 유래 지방산 spillover는 BMI, 허리둘레, HOMA-IR, 공복 중성지방과 대체로 역상관을 보였습니다. 이 결과는 spillover가 비만에서 과도한 유리지방산을 공급하는 주된 경로라는 단순한 설명과 잘 맞지 않습니다."
/>
...
이 지점은 케빈 홀의 [2021년 식물성 저지방 식단과 동물성 케토 식단 대사병동 연구](/docs/2021-plant-low-fat-animal-ketogenic-ad-libitum)를 읽을 때 직접 연결됩니다. 그 연구에서 동물성 케토 식단은 혈당과 인슐린을 낮췄지만, 참가자들은 식물성 저지방 식단에서 더 적은 에너지를 먹었고 체지방 감소 신호도 더 뚜렷했습니다. Fielding의 논문은 왜 이런 결과가 단순한 역설이 아닌지 설명해 줍니다. 식후 지방 대사는 인슐린 하나로 잠기거나 풀리는 스위치가 아니라, 저장, spillover, 산화, 재순환이 동시에 일어나는 흐름이기 때문입니다.
