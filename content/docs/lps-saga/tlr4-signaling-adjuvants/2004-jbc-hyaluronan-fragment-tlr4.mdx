...
2004년 Kristen R. Taylor 등의 연구는 <strong>히알루론산</strong>(hyaluronan, HA) 파편이 <strong>톨유사수용체 4</strong>(Toll-like receptor 4, TLR4)를 통해 신호를 전달할 수 있음을 비교적 명확하게 보여준 초기 연구입니다.

핵심은 단순한 관찰이 아니라 기능적 입증입니다. 연구진은 세포외기질 파편이 실제로 TLR4 의존적 반응을 유도한다는 근거를 제시했고, 이는 이후 <strong>무균성 염증</strong>(sterile inflammation) 개념이 정교해지는 데 중요한 토대가 되었습니다.
...
마이크로어레이 분석에서 sHA 자극 후 가장 크게 증가한 유전자는 <strong>인터루킨-8</strong>(interleukin-8, IL-8)이었습니다. Table I에서는 IL-8 전사체가 약 56배 증가한 것으로 제시됩니다.
