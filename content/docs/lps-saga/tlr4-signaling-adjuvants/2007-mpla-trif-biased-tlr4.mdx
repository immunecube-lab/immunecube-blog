...
이 역설을 설명하기 위해 연구진은 <strong>TLR4(toll-like receptor 4)</strong> 신호를 두 갈래로 나누어 분석했습니다. 바로 **MyD88 의존 경로**와 **TRIF 의존 경로**입니다.
...
이 공백은 2008년 **Immunity**에 발표된 “The Molecular Basis for Adjuvant Activity of Monophosphoryl Lipid A”에서 보완됩니다.  
