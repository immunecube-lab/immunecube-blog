...
2006년 Park 등의 연구는 <strong>고이동성 그룹 박스 1 단백질</strong>(high mobility group box 1 protein, HMGB1)이 <strong>톨유사수용체 2</strong>(TLR2)와 <strong>톨유사수용체 4</strong>(TLR4)에 직접 결합할 수 있음을 비교적 명확하게 제시한 논문입니다.
...
이 논문의 핵심 실험 중 하나는 <strong>형광 공명 에너지 전달</strong>(fluorescence resonance energy transfer, FRET) 분석입니다. FRET은 대략 1-10 nm 범위의 근접 상호작용을 검출할 수 있어, 세포막 수준의 단백질-단백질 결합 평가에 적합합니다.
