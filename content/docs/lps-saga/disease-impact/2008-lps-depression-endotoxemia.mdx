...
이 문맥에서 <strong>지질다당류</strong>(lipopolysaccharide, LPS)는 중요한 후보입니다. LPS는 <strong>톨유사수용체 4</strong>(Toll-like receptor 4, TLR4)를 통해 TNF-a, IL-1b, IL-6 같은 염증성 사이토카인 반응을 유도할 수 있고, 장 장벽이 약화되면 저강도 내독소혈증 형태로 혈중에 노출될 수 있기 때문입니다.
