...
이러한 염증 반응을 유발하는 상위 자극이 무엇인지에 대한 질문이 최근 연구의 핵심이었습니다. 2023년 프란체스코 비올리(Francesco Violi) 연구팀의 종설은 그 후보 중 하나로 <strong>리포폴리사카라이드</strong>(lipopolysaccharide, LPS)를 제시합니다.
...
혈중으로 유입된 LPS는 <strong>톨유사수용체 4</strong>(Toll-like receptor 4, TLR4)에 결합하여 하위 신호전달 경로를 활성화합니다. 이 과정에서 <strong>마이엘로이드 분화 1차 반응 단백질 88</strong>(myeloid differentiation primary response protein 88, MyD88)이 동원되고, 핵인자 NF-κB가 활성화되어 염증성 사이토카인 분비가 증가합니다.
