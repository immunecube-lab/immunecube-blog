...
이 관점에서 HSP는 세포의 “응급 수리공”이라기보다, 평상시에도 작동하는 <strong>단백질 품질관리 네트워크(proteostasis network)</strong>의 핵심입니다.
...
둘째, 세포 밖으로 나온 HSP가 선천면역을 자극하는 <strong>DAMP(damage-associated molecular pattern)</strong>처럼 작동할 수 있다는 주장이 제기되었습니다. 특히 HSP70, HSP60, gp96 같은 단백질이 단핵구나 수지상세포를 활성화한다는 연구들이 발표되었습니다.
