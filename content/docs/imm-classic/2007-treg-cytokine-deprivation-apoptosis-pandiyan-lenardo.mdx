...
description: >-
  Pandiyan 외(2007, Nature Immunology)는 CD4⁺CD25⁺FOXP3⁺ 조절 T 세포(Treg)가 효과 CD4⁺ T세포(Teff)를 직접 ‘기능 저하’시키는 수준을 넘어, 사이토카인 결핍(cytokine deprivation)을 통해
  아폽토시스(apoptosis)로 유도할 수 있음을 in vitro·in vivo에서 제시했습니다. Treg의 억제 메커니즘 논쟁을 ‘IL-2 소비(IL-2 sink)’라는 관점에서 다시 정리한 대표 논문입니다.
...
takeaway="조절 T 세포(regulatory T cell, Treg)는 효과 CD4⁺ T 세포(effector CD4⁺ T cell)의 초기 활성화 자체를 막기보다, 공통 감마 사슬(common γ chain, γc) 계열 사이토카인을 ‘소비’해 반응 세포를 <b>사이토카인 결핍</b>(cytokine deprivation) 상태로 몰아넣고, 결국 <b>아폽토시스</b>(apoptosis)로 제거할 수 있음을 보여 준 논문입니다." 
  doi="10.1038/ni1536"
/>
