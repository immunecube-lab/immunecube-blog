...
교토대학교의 **Tasuku Honjo** 연구팀은 활성화 유도 세포사(activation-induced cell death) 과정에서 특이적으로 발현되는 유전자를 찾기 위해 subtractive hybridization 기법을 사용했습니다. Honjo는 이 흐름을 끝까지 밀고 가 PD-1 면역관문 연구를 확립한 공로로 훗날 **2018년 노벨 생리의학상을 받은 노벨상 수상자**가 됩니다.
...
하나는 PMA와 ionomycin으로 세포사가 유도된 T세포주였고, 다른 하나는 항-IgM(anti-IgM)으로 자극된 B세포주였습니다.
