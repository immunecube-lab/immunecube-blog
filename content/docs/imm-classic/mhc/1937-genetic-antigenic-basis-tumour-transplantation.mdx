...
<Figure
  src="/images/person/peter-alfred-gorer.webp"
  alt="Peter Alfred Gorer"
  caption="Peter Alfred Gorer. 종양 이식 실험을 통해 유전적으로 결정되는 항원 차이가 이식 성패와 연결된다는 문제를 선명하게 드러낸 연구자입니다."
  number={1}
  maxWidth={400}
/>
