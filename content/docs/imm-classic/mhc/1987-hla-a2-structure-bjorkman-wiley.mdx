...
<FigureGroup
  images={[
    { src: "/images/person/pamela-bjorkman.webp", alt: "Pamela Bjorkman", label: "Pamela Bjorkman" },
    { src: "/images/person/don-wiley.webp", alt: "Don Wiley", label: "Don Wiley" },
  ]}
  caption="Pamela Bjorkman과 Don Wiley"
  number={1}
  maxWidth={760}
/>
