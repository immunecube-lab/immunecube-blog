...
조직 분석에서는 T세포 침윤이 감소했고, 염증성 조직 파괴가 완화되었으며, 면역세포 활성 지표도 함께 낮아졌습니다. 이는 B7–CD28 상호작용이 효과적으로 차단되었음을 의미했습니다. 즉, T세포 활성화의 필수 보조자극이 차단되면서 거부반응이 억제된 것입니다.
...
이 연구의 의미는 매우 큽니다. 먼저 CTLA-4 경로가 생체 내에서도 실제로 작동하는 억제 신호임을 처음으로 입증했습니다. 또 B7–CD28 축의 차단만으로 이식면역을 조절할 수 있다는 가능성을 보여주었고, 면역관용이 분자적으로 조절 가능한 과정임을 제시했습니다. 더 나아가 이후 면역관문을 표적으로 한 치료 전략 개발의 실질적 토대를 마련했습니다. 이 연구는 면역을 단순히 억제하는 것이 아니라, 선택적으로 재조정할 수 있다는 개념을 제시했습니다.
