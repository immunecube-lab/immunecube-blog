---
title: "1985년 - CD28 보조자극의 발견: 9.3 항체와 Ledbetter의 ‘두 번째 신호’ 실험 (1985)"
...
1980년대 초, 면역학계의 최대 화두는 <strong>T세포 수용체</strong>(TCR)였습니다. TCR이 항원을 인식한다는 사실은 밝혀졌지만, 이상한 점이 하나 있었습니다. 실험실에서 TCR만 자극했을 때 T세포는 기대만큼 강력하게 반응하지 않았던 것입니다.
...
Ledbetter 연구진은 변수를 철저히 통제하기 위해 **고도로 정제된 인간 T세포**만을 추출했습니다. 부가적인 도움을 줄 수 있는 다른 세포(APC)가 없는 상태에서 그들이 관찰한 결과는 극적이었습니다. **신호 1 (항-CD3) 단독**에서는 T세포가 살짝 활성화되는 듯했으나 증식은 미미했고, **신호 2 (9.3 항체) 단독**에서는 아무런 반응을 보이지 않았습니다. 반면 **신호 1 + 신호 2 병용**에서는 두 항체를 동시에 처리하자 T세포가 폭발적으로 증식하기 시작했고 IL-2 생산량은 수십 배로 뛰었습니다.
...
이 발견 이후 Tp44는 **CD28**로 명명되었고, 현대 면역학의 근간인 <strong>2-신호 모델</strong>(Two-signal model)이 완성되었습니다. 즉 <strong>신호 1 (인식)</strong>으로 TCR이 항원을 식별하고, <strong>신호 2 (보조자극)</strong>로 CD28이 리간드와 결합해 활성화 허가를 내리는 구조입니다.
