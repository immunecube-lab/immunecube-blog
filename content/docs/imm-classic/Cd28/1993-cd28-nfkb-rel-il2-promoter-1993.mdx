...
NF-κB는 IL-2, TNF-α, IFN-γ, IL-6, GM-CSF, 항아폽토시스 유전자(Bcl-xL 등) 같은 유전자들의 전사를 유도합니다. 즉, **면역 반응을 시작하고 유지하는 ‘점화 장치’**에 해당하는 전사인자입니다.


## 🔁 NF-κB는 하나의 단백질이 아니다

NF-κB는 단일 단백질이 아니라 **패밀리(family)** 입니다. 주요 구성원으로는 **RelA (p65)**, **c-Rel**, p50 (NF-κB1), p52 (NF-κB2), RelB가 있습니다. 이 단백질들은 서로 **이합체(dimer)**를 형성하여 DNA에 결합합니다. 특히 T세포에서는 **RelA와 c-Rel이 IL-2 전사에 가장 중요**합니다.
