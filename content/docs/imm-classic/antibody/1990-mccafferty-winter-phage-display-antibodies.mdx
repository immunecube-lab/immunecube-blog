...
<AuthorBio person="gregory-winter" />
...
원문에서 사용한 항체는 hen egg-white lysozyme에 결합하는 **D1.3 항체**였습니다. 연구진은 D1.3의 VH와 VL을 유연한 peptide linker로 이어 <strong>single-chain Fv</strong>(scFv)를 만들고, 이를 fd phage의 **gene III protein** N-말단 쪽에 융합했습니다. gene III protein은 fd phage 끝부분에 존재하며 세균 F pilus에 붙는 데 관여하는 단백질입니다.
