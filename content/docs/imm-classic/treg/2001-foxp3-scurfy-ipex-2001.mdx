...
<FigureGroup
  images={[
    { src: "/images/person/mary-brunkow.webp", alt: "Mary Brunkow", label: "Mary Brunkow" },
    { src: "/images/person/fred-ramsdell.webp", alt: "Fred Ramsdell", label: "Fred Ramsdell" },
  ]}
  caption="Mary Brunkow와 Fred Ramsdell"
  number={1}
  maxWidth={760}
/>
