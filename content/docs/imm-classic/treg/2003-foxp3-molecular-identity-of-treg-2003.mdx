---
title: "2003년 - FOXP3⁺ Treg의 분자적 정체는 어떻게 확립되었는가"
...
이 질문에 대한 답이 바로 <strong>FOXP3</strong>(Forkhead box P3)에서 나왔습니다. 2003년의 일련의 연구는 조절 T세포를 기능적 추정이 아닌, 유전적·분자적 실체로 확립한 전환점이었습니다.
...
이 질문에 정면으로 답한 연구가 2003년 발표되었습니다. 대표적으로 <strong>시몬 사카구치</strong>(Shimon Sakaguchi) 연구팀과 <strong>알렉세이 루덴스키</strong>(Alexei Rudensky) 연구팀의 연구가 결정적이었습니다.
...
IL-2 생성은 감소했고, CD25 및 CTLA-4 발현은 증가했으며, 자극에 대한 반응성은 낮아졌고, 다른 T세포의 증식을 억제하는 능력까지 나타났습니다. 이는 단순한 표면 표지 변화가 아니라 세포의 전사 프로그램과 기능적 정체성이 재구성된 것이었습니다.
...
이후 조절 T세포 연구는 자가면역 질환 병태생리, 장내 면역 항상성, 종양 미세환경에서의 면역 억제, 면역관문억제제의 작동 원리 같은 영역으로 확장되었습니다. 특히 CTLA-4를 표적으로 하는 면역관문억제제는 조절 T세포의 억제 기전 이해와 밀접하게 연결되어 있습니다.
