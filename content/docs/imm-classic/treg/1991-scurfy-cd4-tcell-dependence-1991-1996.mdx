...
1991년에는 병리의 전모가 규명되었고, 1994년에는 세포 중심 축이 더 구체화되었으며, 1996년에는 CD4 의존성이 기능적으로 확립되었고, 2001년에는 FOXP3가 규명되었습니다. 이 시간의 축을 따라가면, 면역관용이 단순한 개념이 아니라 **CD4⁺ 기반 조절 회로에 의해 유지된다는 사실**이 어떻게 드러났는지 이해할 수 있습니다.
