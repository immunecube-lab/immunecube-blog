---
title: "1996년 - 조절 T세포의 발생학적 결정시기: d3Tx 모델로 밝힌 CD4⁺CD25⁺ T세포의 기원 (1996)"
...
출생 직후에는 CD25⁺ 세포가 거의 검출되지 않았고, 생후 수일 후부터 말초에서 CD25⁺ 집단이 출현하기 시작했으며, 생후 약 2주가 되면 성체 수준에 가까워졌습니다. 즉, CD4⁺CD25⁺ T세포는 태어날 때 완성된 집단이 아니라, 생후 초기 흉선 발달 과정을 거쳐 생성되는 집단이었습니다.
...
1995년에는 CD4⁺CD25⁺ 세포의 억제 기능이 입증되었고, 1996년에는 그 세포의 발생학적 결손이 자가면역을 유발함이 밝혀졌으며, 2001년에는 FOXP3가 이 세포의 핵심 전사인자임이 규명되었습니다. 즉, 이 논문은 Treg 개념을 “기능적 가설”에서 “발달 프로그램을 가진 독립 세포 집단”으로 격상시킨 중요한 연결 고리입니다.

## 7. 과학적 의의

이 연구가 남긴 가장 중요한 메시지는 면역관용이 발달적으로 형성되며, 자가면역은 공격 세포의 과다 문제가 아니라 조절 집단의 결핍 문제일 수 있고, 생후 초기의 흉선 환경이 평생의 면역 균형을 결정할 수 있다는 점입니다. 이 통찰은 이후 FOXP3 발견과 Treg 생물학 확립의 기반이 되었습니다.
