...
2000년 <strong>폴 M. 앨런</strong>(Paul M. Allen) 연구팀이 돌연변이 신생항원을 인식하는 TCR을 이용해 종양 제거를 입증했다면, 그 다음 질문은 훨씬 더 도전적이었습니다.

“이미 존재하는 T세포의 특이성을 유전자 조작으로 바꿀 수 있을까?”

이 질문에 본격적으로 답한 인물이 <strong>톤 N. 슈마허</strong>(Ton N. Schumacher) 연구팀입니다. 만약 특정 항원을 인식하는 TCR을 원하는 T세포에 직접 입력할 수 있다면, 입양세포치료(adoptive cell transfer, ACT)는 훨씬 유연해지고, 개인맞춤형 치료의 가능성도 크게 확장됩니다.
