...
Ott 연구는 long-peptide와 poly-ICLC 기반 접근이었고, Sahin 연구는 mRNA 기반 접근이었습니다. 두 연구 모두 환자별 유전체 분석으로 신항원을 선별했다는 점에서는 같았고, 제조 속도와 플랫폼 확장성 측면에서는 mRNA가 상대적으로 유리한 잠재력을 보여주었습니다.

## 왜 이 연구가 중요한가

이 연구는 여러 면에서 역사적 의미를 갖습니다.

mRNA 기반 개인 맞춤형 신항원 백신이 실제로 환자에서 작동한다는 임상적 증명이라는 점이 첫 번째 의미입니다. mRNA 플랫폼의 신속한 제작 가능성과 유연성이 임상적으로 실현 가능함을 보여주었다는 점도 중요합니다. 더 나아가 암종과 무관하게 적용 가능한 개인 맞춤형 면역치료 플랫폼의 가능성을 제시했습니다. 이 기술적 기반은 이후 감염병 백신 개발, 특히 코로나19 mRNA 백신 개발로까지 확장되었습니다.

## 연구의 한계와 해석상 주의점

이 연구는 역사적으로 매우 중요하지만, 다음 한계를 함께 고려해야 합니다.

환자 수가 제한적이어서(13명) 효과 크기의 확정에는 한계가 있고, 초기 단계 임상이라 장기 생존 이득과 표준치료 대비 우월성은 후속 무작위 연구가 필요합니다. 개인 맞춤형 제조 공정의 비용, 속도, 확장성도 실제 임상 도입의 핵심 변수입니다.

## 후속 파급효과: mRNA 플랫폼의 확장

코로나19 mRNA 백신 개발은 <strong>모더나</strong>(Moderna)와 **BioNTech-Pfizer**가 거의 동시에 시작했습니다.
