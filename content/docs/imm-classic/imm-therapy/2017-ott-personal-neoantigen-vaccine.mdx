...
6명 중 4명은 장기간 무병 상태를 유지했습니다. 재발한 2명 역시 이후 PD-1 억제제인 <strong>펨브롤리주맙</strong>(pembrolizumab, 제품명 **키트루다**[Keytruda]) 또는 <strong>니볼루맙</strong>(nivolumab, 제품명 **옵디보**[Opdivo]) 치료를 받았고, 완전관해에 도달했습니다.
...
Ott 연구는 long-peptide와 poly-ICLC 기반 접근이었고, Sahin 연구는 mRNA 기반 접근이었습니다. 두 연구 모두 환자별 유전체 분석으로 신항원을 선별했다는 점에서는 같았으며, 플랫폼은 달라도 개인 맞춤 신항원 백신이 임상적으로 가능하다는 결론을 독립적으로 재확인했다는 점이 중요합니다.

## 왜 이 연구가 중요한가

이 연구는 여러 면에서 역사적 의미를 갖습니다.

각 환자의 종양 유전체를 기반으로 한 개인 맞춤형 백신 제작이 실제로 가능함을 임상에서 입증했다는 점이 첫 번째 의미입니다. 신항원이 실제로 표적 가능한 항원이라는 임상적 증거를 제시했다는 점도 중요합니다. 여기에 더해 백신과 면역관문억제제를 결합한 연속 치료 전략의 개념을 제시함으로써 이후 암백신 연구의 방향까지 열어 주었습니다. 이 연구는 이후 Moderna, BioNTech 등에서 개발 중인 mRNA 기반 맞춤형 암백신 연구의 촉매제가 되었습니다.

## 연구의 한계와 해석상 주의점

이 연구는 개념 증명으로 매우 중요하지만, 다음 한계를 함께 봐야 합니다.

환자 수가 6명으로 매우 작아 확정적 임상 효과를 일반화하기 어렵고, 단일군 성격의 초기 임상이라 무작위 대조군 비교도 아니었습니다. long-peptide 제조 공정과 적용 범위는 실제 대규모 도입 시 추가 검증이 필요합니다.
