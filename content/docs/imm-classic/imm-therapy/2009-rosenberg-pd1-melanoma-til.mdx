...
<strong>스티븐 A. 로젠버그</strong>(Steven A. Rosenberg) 연구팀은 이러한 기능장애를 유발하는 억제 신호 분자를 규명하고자 했습니다. 그 과정에서 오늘날 면역항암 치료의 핵심 표적이 된 PD-1의 중요성이 밝혀졌습니다.
...
둘째, 이후 등장한 PD-1 억제 항체 치료의 기전적 토대를 형성했습니다. 예를 들어 <strong>펨브롤리주맙</strong>(pembrolizumab, 제품명 **키트루다**[Keytruda])과 <strong>니볼루맙</strong>(nivolumab, 제품명 **옵디보**[Opdivo])과 같은 치료제는 PD-1 신호를 차단하여 T세포 기능을 회복시키는 전략입니다.
