...
즉, 초기 활성화와 종양 내 재활성화를 동시에 자극하면 시너지 효과가 나타날 것이라는 가설이 제기되었습니다. 이를 대규모로 검증한 연구가 바로 <strong>제임스 라킨</strong>(James Larkin) 연구팀의 3상 임상시험입니다.
...
객관적 반응률(ORR)도 병용요법이 가장 높았으며, 병용요법 57.6%, PD-1 단독 43.7%, CTLA-4 단독 19.0%로 보고되었습니다.
