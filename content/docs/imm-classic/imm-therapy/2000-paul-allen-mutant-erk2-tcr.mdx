...
1990년대 세포치료 연구는 세포독성 T림프구(CTL), 인터루킨-2(IL-2), 종양침윤림프구(TIL)를 중심으로 발전했습니다. 그러나 이 전략들은 모두 종양을 인식하는 <strong>T세포 수용체</strong>(T cell receptor, TCR)의 특이성에 크게 의존했습니다.
...
이 가설을 실험적으로 입증한 인물이 바로 <strong>폴 M. 앨런</strong>(Paul M. Allen) 연구팀입니다.
