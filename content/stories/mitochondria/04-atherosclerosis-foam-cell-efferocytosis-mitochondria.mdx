...
<Figure
  src="/images/diagram/동맥경화-혈관벽통과3.svg"
  alt="LDL의 혈관벽 잔류부터 단핵구 유입, 거품세포 형성과 혈관평활근세포 반응까지 이어지는 과정"
  caption="LDL이 혈관벽에 남은 뒤 단핵구가 유입되고, 대식세포·거품세포와 혈관평활근세포가 반응하는 죽상동맥경화의 기본 구조입니다."
  number={1}
  maxWidth={900}
/>
