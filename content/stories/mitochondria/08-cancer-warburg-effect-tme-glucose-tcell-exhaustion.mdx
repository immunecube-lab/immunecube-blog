...
심하게 손상된 정상세포는 미토콘드리아 외막에 있는 BAX와 BAK를 활성화해 막에 통로를 만듭니다. 이를 **미토콘드리아 외막 투과화(MOMP)**라고 합니다. MOMP가 일어나면 cytochrome c가 세포질로 나오고 apoptosome과 caspase-9, caspase-3/7이 차례로 활성화되어 세포가 제거됩니다.
