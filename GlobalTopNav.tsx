...
export function GlobalTopNav() {
  ...
  return (
    <header data-pagefind-ignore="all" className="sticky top-0 z-50 w-full border-b border-neutral-200/80 bg-white/80 backdrop-blur-md print:hidden dark:border-neutral-800 dark:bg-neutral-950/80">
